...
<head>
    ...
    {{-- 2. 폰트 설정 (뉴스 포털 스타일 + Cobalt Glow용 Inter) --}}
    ...
    {{-- 3. 자산 로드 (Cobalt Glow 경로 반영) --}}
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/views/skin/layout/cobalt-glow/style.css'])
