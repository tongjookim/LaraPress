{{--
    스마트에디터2 초기화 partial
    사용법: @include('partials.smarteditor', ['editorId' => 'se2_content'])
    - $editorId     : textarea의 id 속성값 (필수)
    - $editorHeight : 에디터 높이(px), 기본 500
    모바일(≤768px)에서는 SmartEditor2 대신 경량 contenteditable 에디터 사용
--}}
@push('scripts')
<style>
/* ── 모바일 경량 에디터 ── */
