<?php $__env->startSection('title', '회원 추가'); ?>
    ...
    <div class="wp-widget-body">
        <form action="<?php echo e(route('admin.user.store')); ?>" method="POST">
            ...
            <div class="wp-form-group">
                ...
                <input type="text" name="username" value="<?php echo e(old('username')); ?>" required class="wp-form-input" placeholder="영문, 숫자, _ - 만 사용 가능">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="wp-form-group">
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="wp-form-input">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="wp-form-group">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="wp-form-input">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="wp-form-group">
                ...
                <select name="role" class="wp-form-input wp-form-select">
                    <option value="subscriber" <?php echo e(old('role')=='subscriber'?'selected':''); ?>>구독자</option>
                    <option value="author"     <?php echo e(old('role')=='author'    ?'selected':''); ?>>작성자</option>
                    <option value="editor"     <?php echo e(old('role')=='editor'    ?'selected':''); ?>>편집자</option>
                    <option value="admin"      <?php echo e(old('role')=='admin'     ?'selected':''); ?>>관리자</option>
                </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laraboard/www/resources/views/admin/user-create.blade.php ENDPATH**/ ?>