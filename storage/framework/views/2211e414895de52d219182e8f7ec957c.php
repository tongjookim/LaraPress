...
<?php $__env->startSection('head-meta-override'); ?><?php $__env->stopSection(); ?>

<?php $__env->startPush('head-meta'); ?>
<?php
...
?>
<meta name="description" content="<?php echo e($_artDesc); ?>">
<?php if($article->meta_keywords || \App\Models\Setting::get('meta_keywords')): ?>
<meta name="keywords" content="<?php echo e($article->meta_keywords ?: \App\Models\Setting::get('meta_keywords')); ?>">
<?php endif; ?>
<?php if(\App\Models\Setting::get('meta_author') || ($article->user->name ?? '')): ?>
<meta name="author" content="<?php echo e($article->user->name ?? \App\Models\Setting::get('meta_author')); ?>">
<?php endif; ?>
<meta property="og:type"        content="article">
<meta property="og:site_name"   content="<?php echo e($_siteName); ?>">
<meta property="og:title"       content="<?php echo e($_artTitle); ?>">
<meta property="og:description" content="<?php echo e($_artDesc); ?>">
<meta property="og:url"         content="<?php echo e(url('/news/' . $article->slug)); ?>">
<?php if($_artImg): ?><meta property="og:image" content="<?php echo e($_artImg); ?>"><?php endif; ?>
<?php if($article->published_at): ?><meta property="article:published_time" content="<?php echo e($article->published_at->toIso8601String()); ?>"><?php endif; ?>
<?php if($article->updated_at): ?><meta property="article:modified_time"  content="<?php echo e($article->updated_at->toIso8601String()); ?>"><?php endif; ?>
<?php if($article->category): ?><meta property="article:section" content="<?php echo e($article->category->name); ?>"><?php endif; ?>
<meta name="twitter:card"        content="<?php echo e(\App\Models\Setting::get('meta_twitter_card','summary_large_image')); ?>">
<meta name="twitter:title"       content="<?php echo e($_artTitle); ?>">
<meta name="twitter:description" content="<?php echo e($_artDesc); ?>">
<?php if($_artImg): ?><meta name="twitter:image" content="<?php echo e($_artImg); ?>"><?php endif; ?>
<?php if(\App\Models\Setting::get('rss_enabled','1') === '1'): ?>
<link rel="alternate" type="application/rss+xml" title="<?php echo e($_siteName); ?>" href="<?php echo e(url('/feed')); ?>">
<?php endif; ?>
<?php $__env->stopPush(); ?>
...
<div class="nyt-article-wrap">
    ...
    <article>
        <header class="nyt-article-header">
            ...
            <a href="<?php echo e(route('news.index', ['category' => $article->category->slug])); ?>" class="nyt-article-section"><?php echo e($article->category->name); ?></a>
            <?php endif; ?>
            <h1 class="nyt-article-title"><?php echo e($article->title); ?></h1>
            <?php if($article->subtitle): ?>
            <p class="nyt-article-subtitle"><?php echo e($article->subtitle); ?></p>
            <?php endif; ?>
            <div class="nyt-article-byline">
                <strong><?php echo e($article->user->name); ?></strong>
                <time datetime="<?php echo e($article->published_at?->toDateString() ?? $article->created_at->toDateString()); ?>">
                    <?php echo e($article->published_at?->format('Y년 m월 d일 H:i') ?? $article->created_at->format('Y년 m월 d일 H:i')); ?>
        ...
        <p class="nyt-article-excerpt"><?php echo e($article->excerpt); ?></p>
        <?php endif; ?>
        ...
        <div class="nyt-article-footer">
            <span>최종 수정: <?php echo e($article->updated_at->format('Y.m.d H:i')); ?></span>
            <a class="nyt-back-link"
               href="<?php echo e(route('news.index', $article->category ? ['category' => $article->category->slug] : [])); ?>">
                ← <?php echo e($article->category?->name ?? '전체'); ?> 목록
            </a>
        </div>

        
        <?php if($article->user->author_box_enabled): ?>
        <?php
            $author = $article->user;
            $hasSocials = collect($authorSocials)->keys()->some(fn($f) => !empty($author->$f));
        ?>
        <div class="nyt-author-box">
            <a href="<?php echo e(route('journalist.show', $author->username)); ?>" class="nyt-author-box__header">
                <?php if($author->profile_image): ?>
                    <img src="<?php echo e($author->profile_image); ?>" alt="<?php echo e($author->name); ?>" class="nyt-author-box__avatar">
                <?php else: ?>
                    <div class="nyt-author-box__avatar-placeholder"><?php echo e(mb_substr($author->name, 0, 1)); ?></div>
                <?php endif; ?>
                <div style="flex:1;min-width:0;">
                    <span class="nyt-author-box__name"><?php echo e($author->name); ?></span>
                    <span class="nyt-author-box__role"><?php echo e($author->roleLabel()); ?></span>
                    <?php if($author->bio): ?>
                    <p class="nyt-author-box__bio"><?php echo e($author->bio); ?></p>
                    <?php endif; ?>
                </div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:0;padding:8px 16px;border-top:1px solid var(--nyt-border);">
                <?php $__currentLoopData = $authorSocials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <a href="<?php echo e($href); ?>" target="<?php echo e($field==='social_email'?'_self':'_blank'); ?>" rel="noopener noreferrer"
                   title="<?php echo e($meta['label']); ?>"
                   style="display:inline-flex;align-items:center;gap:5px;padding:5px 10px;font-size:12px;font-family:var(--nyt-sans);font-weight:600;text-decoration:none;color:<?php echo e($meta['color']); ?>;transition:opacity .12s;margin:2px;"
                   onmouseover="this.style.opacity='.7'" onmouseout="this.style.opacity='1'">
                    <svg width="13" height="13" viewBox="0 0 24 24" <?php echo $strokeStyle; ?>><?php echo $meta['icon']; ?></svg>
        ...
        <div class="nyt-related">
            ...
            <div class="nyt-related-grid">
                ...
                <a href="<?php echo e(route('news.show', $rel->slug)); ?>" class="nyt-related-card">
                    <?php if($rel->thumbnail): ?>
                        <img src="<?php echo e($rel->thumbnail); ?>" alt="<?php echo e($rel->title); ?>">
                    <?php endif; ?>
                    <?php if($rel->category): ?>
                        <span class="nyt-related-card__cat"><?php echo e($rel->category->name); ?></span>
                    <?php endif; ?>
                    <span class="nyt-related-card__title"><?php echo e($rel->title); ?></span>
                    <time class="nyt-related-card__date"><?php echo e($rel->published_at?->format('Y.m.d') ?? $rel->created_at->format('Y.m.d')); ?></time>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <aside class="nyt-art-sidebar">
        ...
        <?php
            $catLatest = \App\Models\Article::with('user')
                ...
                ->limit(6)->get();
        ?>
        <?php if($catLatest->count()): ?>
        <div class="nyt-art-sidebar__card">
            <div class="nyt-art-sidebar__header"><?php echo e($article->category->name); ?></div>
            <?php $__currentLoopData = $catLatest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="nyt-art-sidebar__item">
                <div>
                    <a href="<?php echo e(route('news.show', $a->slug)); ?>" class="nyt-art-sidebar__link"><?php echo e($a->title); ?></a>
                    <time class="nyt-art-sidebar__date"><?php echo e($a->published_at?->format('Y.m.d') ?? $a->created_at->format('Y.m.d')); ?></time>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="nyt-art-sidebar__card">
            ...
            <div class="nyt-art-sidebar__item">
                <span class="nyt-art-sidebar__rank"><?php echo e($i + 1); ?></span>
                <div>
                    <a href="<?php echo e(route('news.show', $a->slug)); ?>" class="nyt-art-sidebar__link"><?php echo e($a->title); ?></a>
                    <time class="nyt-art-sidebar__date">조회 <?php echo e(number_format($a->view_count)); ?></time>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<div class="nyt-comments">
    <div class="nyt-comments-title">댓글 <?php echo e($comments->count()); ?></div>

    <?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="nyt-comment" id="comment-<?php echo e($comment->id); ?>">
        <div class="nyt-comment__header">
            <div class="nyt-comment__avatar"><?php echo e(mb_substr($comment->user->name, 0, 1)); ?></div>
            <span class="nyt-comment__author"><?php echo e($comment->user->name); ?></span>
            <span class="nyt-comment__date"><?php echo e($comment->created_at->format('Y.m.d H:i')); ?></span>
        </div>
        <div class="nyt-comment__content"><?php echo e($comment->content); ?></div>
        <div class="nyt-comment__actions">
            <?php if(auth()->guard()->check()): ?>
            <button class="nyt-comment__btn" onclick="toggleReplyForm(<?php echo e($comment->id); ?>)">답글</button>
            <?php if(auth()->id() === $comment->user_id || auth()->user()->canApproveArticle()): ?>
            <form action="<?php echo e(route('news.comment.delete', [$article->slug, $comment->id])); ?>" method="POST" style="display:inline;" onsubmit="return confirm('댓글을 삭제하시겠습니까?')">
        ...
        <?php if(auth()->guard()->check()): ?>
        <div class="nyt-reply-form" id="reply-form-<?php echo e($comment->id); ?>">
            <form action="<?php echo e(route('news.comment.store', $article->slug)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div style="display:flex;gap:8px;margin-top:6px;">
                    ...
                    <button type="button" class="nyt-comment__btn" onclick="toggleReplyForm(<?php echo e($comment->id); ?>)" style="font-size:13px;text-decoration:none;padding:7px 0;">취소</button>
                </div>
            </form>
        </div>
        <?php endif; ?>
        ...
        <div class="nyt-reply-list">
            ...
            <div class="nyt-reply" id="comment-<?php echo e($reply->id); ?>">
                <div class="nyt-comment__header">
                    <div class="nyt-comment__avatar" style="width:24px;height:24px;font-size:10px;"><?php echo e(mb_substr($reply->user->name, 0, 1)); ?></div>
                    <span class="nyt-comment__author"><?php echo e($reply->user->name); ?></span>
                    <span class="nyt-comment__date"><?php echo e($reply->created_at->format('Y.m.d H:i')); ?></span>
                </div>
                <div class="nyt-comment__content" style="padding-left:34px;"><?php echo e($reply->content); ?></div>
                <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->id() === $reply->user_id || auth()->user()->canApproveArticle()): ?>
                <div class="nyt-comment__actions" style="padding-left:34px;">
                    <form action="<?php echo e(route('news.comment.delete', [$article->slug, $reply->id])); ?>" method="POST" style="display:inline;" onsubmit="return confirm('댓글을 삭제하시겠습니까?')">
                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                        <button type="submit" class="nyt-comment__btn" style="color:#c0392b;">삭제</button>
                    </form>
                </div>
    ...
    <div class="nyt-comment-form">
        ...
        <?php if(session('success')): ?>
            <div style="background:#f0fdf4;border:1px solid #86efac;padding:10px 14px;font-size:13px;color:#166534;margin-bottom:12px;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div style="background:#fef2f2;border:1px solid #fca5a5;padding:10px 14px;font-size:13px;color:#991b1b;margin-bottom:12px;"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        <form action="<?php echo e(route('news.comment.store', $article->slug)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <textarea name="content" rows="4" placeholder="댓글을 입력하세요..." required maxlength="2000"><?php echo e(old('content')); ?></textarea>
            <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p style="color:#c0392b;font-size:12px;margin-top:4px;"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="nyt-login-prompt">
        댓글을 작성하려면 <a href="<?php echo e(route('login')); ?>">로그인</a>이 필요합니다.
    </div>
    <?php endif; ?>
</div>
<?php endif; ?>
...
<?php if($article->thumbnail): ?>
<div class="mag-hero">
    <img class="mag-hero__img" src="<?php echo e($article->thumbnail); ?>" alt="<?php echo e($article->title); ?>">
    <div class="mag-hero__overlay"></div>
    <div class="mag-hero__body">
        <?php if($article->category): ?>
            <span class="mag-hero__cat"><?php echo e($article->category->name); ?></span>
        <?php endif; ?>
        <h1 class="mag-hero__title"><?php echo e($article->title); ?></h1>
        <?php if($article->subtitle): ?>
            <p class="mag-hero__subtitle"><?php echo e($article->subtitle); ?></p>
        <?php endif; ?>
        <div class="mag-hero__meta">
            <span><?php echo e($article->user->name); ?></span>
            <span class="mag-hero__meta-dot">|</span>
            <span><?php echo e($article->published_at?->format('Y년 m월 d일') ?? $article->created_at->format('Y년 m월 d일')); ?></span>
            <span class="mag-hero__meta-dot">|</span>
            <span>조회 <?php echo e(number_format($article->view_count)); ?></span>
        </div>
    </div>
</div>
<?php else: ?>
...
<nav class="mag-breadcrumb">
    <a href="<?php echo e(route('news.index')); ?>">뉴스</a>
    <?php if($article->category): ?>
        <span class="mag-breadcrumb__sep">›</span>
        <a href="<?php echo e(route('news.index', ['category' => $article->category->slug])); ?>"><?php echo e($article->category->name); ?></a>
    <?php endif; ?>
    <span class="mag-breadcrumb__sep">›</span>
    <span style="color:#8a9ea6;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:320px;"><?php echo e($article->title); ?></span>
</nav>
...
<div class="mag-layout">
    ...
    <article class="mag-article">
        ...
        <?php if($article->excerpt): ?>
        <p class="mag-excerpt"><?php echo e($article->excerpt); ?></p>
        <?php endif; ?>

        <div class="mag-byline">
            <span class="mag-byline__author"><?php echo e($article->user->name); ?></span>
            <time class="mag-byline__date" datetime="<?php echo e($article->published_at?->toDateString() ?? $article->created_at->toDateString()); ?>">
                <?php echo e($article->published_at?->format('Y년 m월 d일 H:i') ?? $article->created_at->format('Y년 m월 d일 H:i')); ?>
        ...
        <div style="margin-top:32px;border:1px solid var(--m-border);border-radius:6px;overflow:hidden;">
            <a href="<?php echo e(route('journalist.show', $author->username)); ?>"
               ...
               onmouseover="this.style.opacity='.88'" onmouseout="this.style.opacity='1'">
                <?php if($author->profile_image): ?>
                    <img src="<?php echo e($author->profile_image); ?>" alt="<?php echo e($author->name); ?>"
                ...
                <div style="flex:1;min-width:0;">
                    <div style="display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin-bottom:4px;">
                        <span style="font-size:16px;font-weight:900;color:#fff;"><?php echo e($author->name); ?></span>
                        <span style="font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;background:rgba(255,255,255,.2);color:rgba(255,255,255,.9);"><?php echo e($author->roleLabel()); ?></span>
                    </div>
                    <?php if($author->bio): ?>
                    <p style="font-size:13px;line-height:1.6;color:rgba(255,255,255,.7);margin:0;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;"><?php echo e($author->bio); ?></p>
                    <?php endif; ?>
                </div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:0;background:var(--m-accent-light);border-top:1px solid var(--m-border);padding:10px 18px;">
                ...
                <a href="<?php echo e($href); ?>" target="<?php echo e($field==='social_email'?'_self':'_blank'); ?>" rel="noopener noreferrer"
                   title="<?php echo e($meta['label']); ?>"
                   style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:99px;font-size:12px;font-weight:600;text-decoration:none;color:<?php echo e($meta['color']); ?>;transition:background .12s;margin:2px;"
    ...
    <aside class="mag-sidebar">
        ...
        <div class="mag-sidebar-card">
            <div class="mag-sidebar-header"><?php echo e($article->category->name); ?></div>
            <?php $__currentLoopData = $catLatest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mag-sidebar-item">
                <a href="<?php echo e(route('news.show', $a->slug)); ?>"><?php echo e($a->title); ?></a>
                <time><?php echo e($a->published_at?->format('Y.m.d') ?? $a->created_at->format('Y.m.d')); ?></time>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
        ...
        <div class="mag-sidebar-card">
            ...
            <div class="mag-sidebar-item" style="display:flex;align-items:flex-start;">
                <span class="mag-rank <?php echo e($i < 3 ? 'mag-rank--top' : 'mag-rank--rest'); ?>"><?php echo e($i + 1); ?></span>
                <div style="flex:1;min-width:0;">
                    <a href="<?php echo e(route('news.show', $a->slug)); ?>"><?php echo e($a->title); ?></a>
                    <time>조회 <?php echo e(number_format($a->view_count)); ?></time>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<div class="mag-related">
    ...
    <div class="mag-related-grid">
        <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('news.show', $rel->slug)); ?>" class="mag-related-card">
            <?php if($rel->thumbnail): ?>
                <img class="mag-related-card__img" src="<?php echo e($rel->thumbnail); ?>" alt="<?php echo e($rel->title); ?>">
            <?php endif; ?>
            <div class="mag-related-card__body">
                <?php if($rel->category): ?>
                    <span class="mag-related-card__cat"><?php echo e($rel->category->name); ?></span>
                <?php endif; ?>
                <div class="mag-related-card__title"><?php echo e($rel->title); ?></div>
                <time class="mag-related-card__date">
                    <?php echo e($rel->published_at?->format('Y.m.d') ?? $rel->created_at->format('Y.m.d')); ?>
...
<div class="mag-comments">
    <h2 class="mag-comments-title">댓글 <span style="font-size:15px;font-weight:400;color:var(--m-text-sub);"><?php echo e($comments->count()); ?></span></h2>

    <?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="mag-comment" id="comment-<?php echo e($comment->id); ?>">
        <div class="mag-comment__header">
            <div class="mag-comment__avatar"><?php echo e(mb_substr($comment->user->name, 0, 1)); ?></div>
            <span class="mag-comment__author"><?php echo e($comment->user->name); ?></span>
            <span class="mag-comment__date"><?php echo e($comment->created_at->format('Y.m.d H:i')); ?></span>
        </div>
        <div class="mag-comment__content"><?php echo e($comment->content); ?></div>
        <div class="mag-comment__actions">
            <?php if(auth()->guard()->check()): ?>
            <button class="mag-comment__btn" onclick="toggleReplyForm(<?php echo e($comment->id); ?>)">답글</button>
            <?php if(auth()->id() === $comment->user_id || auth()->user()->canApproveArticle()): ?>
            <form action="<?php echo e(route('news.comment.delete', [$article->slug, $comment->id])); ?>" method="POST" style="display:inline;" onsubmit="return confirm('댓글을 삭제하시겠습니까?')">
                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        <?php if(auth()->guard()->check()): ?>
        <div class="mag-reply-form" id="reply-form-<?php echo e($comment->id); ?>">
            <form action="<?php echo e(route('news.comment.store', $article->slug)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="parent_id" value="<?php echo e($comment->id); ?>">
                ...
                <div style="display:flex;gap:8px;margin-top:6px;">
                    ...
                    <button type="button" class="mag-comment__btn" onclick="toggleReplyForm(<?php echo e($comment->id); ?>)" style="font-size:13px;text-decoration:none;padding:7px 0;">취소</button>
                </div>
            </form>
        </div>
        <?php endif; ?>
        ...
        <div class="mag-reply-list">
            <?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mag-reply" id="comment-<?php echo e($reply->id); ?>">
                <div class="mag-comment__header">
                    <div class="mag-comment__avatar" style="width:26px;height:26px;font-size:11px;"><?php echo e(mb_substr($reply->user->name, 0, 1)); ?></div>
                    <span class="mag-comment__author"><?php echo e($reply->user->name); ?></span>
                    <span class="mag-comment__date"><?php echo e($reply->created_at->format('Y.m.d H:i')); ?></span>
                </div>
                <div class="mag-comment__content" style="padding-left:36px;"><?php echo e($reply->content); ?></div>
                <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->id() === $reply->user_id || auth()->user()->canApproveArticle()): ?>
    ...
    <div class="mag-comment-form">
        ...
        <?php if(session('success')): ?>
            <div style="background:#dcfce7;border:1px solid #86efac;border-radius:4px;padding:10px 14px;font-size:13px;color:#166534;margin-bottom:12px;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div style="background:#fee2e2;border:1px solid #fca5a5;border-radius:4px;padding:10px 14px;font-size:13px;color:#991b1b;margin-bottom:12px;"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        <form action="<?php echo e(route('news.comment.store', $article->slug)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <textarea name="content" rows="4" placeholder="댓글을 입력하세요..." required maxlength="2000"><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make("skin.layout.{$layoutSkin}.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laraboard/www/resources/views/articles/show.blade.php ENDPATH**/ ?>