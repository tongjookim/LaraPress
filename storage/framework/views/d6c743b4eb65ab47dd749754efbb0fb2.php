<?php $__env->startSection('title', '도구'); ?>

<?php $__env->startSection('admin-content'); ?>
<h1 class="wp-page-title">도구</h1>

<?php $activeTab = session('tab', 'export'); ?>
...
<div style="display:flex;gap:0;margin-bottom:24px;border-bottom:2px solid #c3c4c7;flex-wrap:wrap;">
    ...
    <button onclick="switchTab('<?php echo e($key); ?>')" id="tab-btn-<?php echo e($key); ?>"
            style="padding:10px 18px;font-size:13px;font-weight:600;border:none;background:none;cursor:pointer;
                   ...
                   <?php echo e($activeTab === $key ? 'border-bottom-color:#2271b1;color:#2271b1;' : 'color:#646970;'); ?>">
...
<div id="tab-export" class="tab-panel" style="<?php echo e($activeTab === 'export' ? '' : 'display:none;'); ?>">
...
<div id="tab-json" class="tab-panel" style="<?php echo e($activeTab === 'json' ? '' : 'display:none;'); ?>">
    <div class="wp-widget" style="max-width:600px;">
        ...
        <div class="wp-widget-body">
            ...
            <form method="POST" action="<?php echo e(route('admin.tools.import.json')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="wp-form-group">
...
<div id="tab-rss" class="tab-panel" style="<?php echo e($activeTab === 'rss' ? '' : 'display:none;'); ?>">
    <div class="wp-widget" style="max-width:600px;">
        ...
        <div class="wp-widget-body">
            ...
            <form method="POST" action="<?php echo e(route('admin.tools.import.rss')); ?>">
                <?php echo csrf_field(); ?>
                <div class="wp-form-group">
...
<div id="tab-wordpress" class="tab-panel" style="<?php echo e($activeTab === 'wordpress' ? '' : 'display:none;'); ?>">
    <div class="wp-widget" style="max-width:680px;">
        ...
        <div class="wp-widget-body">
            ...
            <form method="POST" action="<?php echo e(route('admin.tools.import.wordpress')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="wp-form-group">
...
<div id="tab-gnuboard" class="tab-panel" style="<?php echo e($activeTab === 'gnuboard' ? '' : 'display:none;'); ?>">
    <div class="wp-widget" style="max-width:680px;">
        ...
        <div class="wp-widget-body">
            ...
            <form id="gnu-csv-form" method="POST" action="<?php echo e(route('admin.tools.import.gnuboard')); ?>"
            ...
            <form id="gnu-db-form" method="POST" action="<?php echo e(route('admin.tools.import.gnuboard')); ?>"
                  style="display:none;">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laraboard/www/resources/views/admin/tools.blade.php ENDPATH**/ ?>