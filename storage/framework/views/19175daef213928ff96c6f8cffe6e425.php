...
var MediaPicker = (function() {
    ...
    function loadMedia(page) {
        ...
        var url    = '<?php echo e(route('admin.media.picker')); ?>?page=' + page +
    ...
    document.getElementById('mp-save-meta').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route('admin.media.update', '__ID__')); ?>'.replace('__ID__', _currentMedia.id), {
            method: 'PUT',
            headers: {
    ...
    document.getElementById('mp-delete-btn').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route('admin.media.delete', '__ID__')); ?>'.replace('__ID__', _currentMedia.id), {
            method: 'DELETE',
...
<?php /**PATH /home/laraboard/www/resources/views/admin/partials/media-picker.blade.php ENDPATH**/ ?>