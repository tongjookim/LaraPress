...
<div class="page-hero">
    <div class="page-hero-inner">
        <nav class="page-breadcrumb">
            <a href="<?php echo e(route('home')); ?>">홈</a>
            <span>›</span>
            <span><?php echo e($page->title); ?></span>
        </nav>
        <h1 class="page-hero-title"><?php echo e($page->title); ?></h1>
...
<div class="page-body-wrap">
    <div class="page-card">
        ...
        <div class="page-back-bar">
            <a href="<?php echo e(route('home')); ?>" class="page-back-btn">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 12H5M12 5l-7 7 7 7"/></svg>
                홈으로 돌아가기
            </a>
            <span class="page-meta-footer"><?php echo e(App\Models\Setting::get('site_name', 'Laraboard')); ?></span>
        </div>
    </div>
</div>
...
<?php echo $__env->make('skin.layout.basic.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laraboard/www/resources/views/page/show.blade.php ENDPATH**/ ?>