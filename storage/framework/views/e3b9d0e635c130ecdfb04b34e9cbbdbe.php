<?php $__env->startSection('title', '미디어 라이브러리'); ?>
...
<div style="display:flex;gap:10px;align-items:center;margin-bottom:16px;flex-wrap:wrap;">
    <form method="GET" action="<?php echo e(route('admin.media')); ?>" style="display:flex;gap:8px;flex:1;min-width:0;">
        <select name="type" class="wp-form-input wp-form-select" style="width:120px;height:32px;padding:4px 8px;">
            <option value="">전체</option>
            <option value="image" <?php echo e(request('type') === 'image' ? 'selected' : ''); ?>>이미지</option>
            <option value="file"  <?php echo e(request('type') === 'file'  ? 'selected' : ''); ?>>파일</option>
        </select>
        ...
        <?php if(request('type') || request('search')): ?>
            <a href="<?php echo e(route('admin.media')); ?>" class="wp-btn wp-btn-secondary" style="height:32px;line-height:1;">초기화</a>
        <?php endif; ?>
    </form>
    <span style="font-size:13px;color:#646970;">총 <?php echo e($media->total()); ?>개</span>
</div>
...
<?php else: ?>
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:12px;margin-bottom:20px;">
        ...
        <a href="<?php echo e(route('admin.media.show', $item->id)); ?>"
            ...
            <div style="height:120px;background:#f0f0f1;display:flex;align-items:center;justify-content:center;overflow:hidden;">
                ...
                <?php else: ?>
                    <div style="text-align:center;padding:12px;">
                        ...
                        <span style="font-size:11px;color:#646970;text-transform:uppercase;"><?php echo e(pathinfo($item->original_name, PATHINFO_EXTENSION)); ?></span>
                    </div>
                <?php endif; ?>
            </div>
            
            <div style="padding:8px 10px;">
                <p style="font-size:12px;color:#2c3338;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-bottom:2px;" title="<?php echo e($item->original_name); ?>">
                    <?php echo e($item->original_name); ?>

                </p>
                <p style="font-size:11px;color:#8c8f94;"><?php echo e($item->formattedSize()); ?> · <?php echo e($item->created_at->format('Y.m.d')); ?></p>
            </div>
        </a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laraboard/www/resources/views/admin/media.blade.php ENDPATH**/ ?>