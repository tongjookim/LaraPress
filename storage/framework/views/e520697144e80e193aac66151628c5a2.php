...
<head>
    ...
    <title>관리자 <?php echo $__env->yieldContent('title'); ?> - <?php echo e(App\Models\Setting::get('site_name', 'Laraboard')); ?></title>
...
<div class="wp-topbar">
    <div class="wp-topbar-left">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" style="display:flex;align-items:center;gap:6px;color:#c3c4c7;text-decoration:none;">
            ...
            <span class="wp-topbar-site-name"><?php echo e(App\Models\Setting::get('site_name', 'Laraboard')); ?></span>
        </a>
    ...
    <div class="wp-topbar-right">
        <span class="wp-topbar-greeting" style="color:#8c8f94;font-size:12px;">안녕하세요, <?php echo e(auth()->user()->name); ?>님</span>
...
<div class="wp-sidebar" id="wpSidebar">
    <div class="wp-sidebar-logo">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>">
            <?php if($adminLogoImage): ?>
                <img src="<?php echo e($adminLogoImage); ?>" alt="<?php echo e($adminLogoText); ?>" style="max-height:30px;max-width:150px;object-fit:contain;">
            <?php else: ?>
    ...
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.articles')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.articles', 'admin.article.*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
        <span>기사 관리</span>
    </a>

    <?php if(auth()->user()->hasMinRole('editor')): ?>
    <a href="<?php echo e(route('admin.article-comments')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.article-comments') ? 'active' : ''); ?>">
        <?php $pendingComments = \App\Models\ArticleComment::whereNull('deleted_at')->where('is_approved', false)->count(); ?>
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
        <span>댓글 관리
            <?php if($pendingComments > 0): ?>
            <span style="display:inline-block;min-width:16px;padding:0 4px;font-size:10px;font-weight:700;border-radius:8px;text-align:center;line-height:16px;background:#d63638;color:#fff;margin-left:4px;"><?php echo e($pendingComments); ?></span>
            <?php endif; ?>
        </span>
    </a>

    <a href="<?php echo e(route('admin.categories')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.categories', 'admin.category.*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
        <span>카테고리</span>
    </a>

    <a href="<?php echo e(route('admin.media')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.media', 'admin.media.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.boards')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.boards', 'admin.board.*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
        <span>게시판 관리</span>
    </a>

    <a href="<?php echo e(route('admin.pages')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.pages', 'admin.page.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.tools')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.tools*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.my-profile')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.my-profile') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.users')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.users', 'admin.user.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.theme')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.theme*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/></svg>
        <span>테마 설정</span>
    </a>

    <a href="<?php echo e(route('admin.top-banners')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.top-banners') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.settings')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.settings') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.seo')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.seo*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
        <span>SEO 설정</span>
    </a>

    <a href="<?php echo e(route('admin.statistics')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.statistics') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
        <span>통계</span>
    </a>

    <a href="<?php echo e(route('admin.mail')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.mail*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
        <span>메일 관리</span>
    </a>

    <a href="<?php echo e(route('admin.plugins')); ?>" class="wp-menu-item <?php echo e(request()->routeIs('admin.plugins', 'admin.plugin.*') ? 'active' : ''); ?>">
...
<div class="wp-main">
    <div class="wp-content">
        ...
        <?php if(session('success')): ?>
            <div class="wp-notice"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div class="wp-notice wp-notice-error"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
...
<?php /**PATH /home/laraboard/www/resources/views/admin/layout.blade.php ENDPATH**/ ?>